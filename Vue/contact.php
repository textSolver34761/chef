  ...
  <body>
    ...
    <form method="post" action="https://formspree.io/pradonbenjamin@gmail.com"id="my-form-element" cf-form>
      ...
      <fieldset>
        ...
        <div class="radio">
                <label>
                    <input cf-questions="Great to meet you, {previous-answer}! I'm a new technologies developper, what do you do?|Awesome, {previous-answer}! And what do you do?" type="radio" name="occupation" id="occupation-4" value="Recrutor">
                    Recrutor
                </label>
        </div>
      </fieldset>
      ...
      <fieldset>
        <label for="reason-contact">Why do you want to contact me?</label>
      ...
      <fieldset>
        <label for="message">What are the message you want to delever me</label>
        <input cf-questions="What message you want to delever me?" type="text" name="message" id="message" class="form-control" required>
    </fieldset>
