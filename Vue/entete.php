...
<div class="boutton">
    ...
    <div class="right"><a href="./signin.php"><input class="ui big red button" type="button" value="Sign in"></a></div>
    <div class="right"><a href="./register.php"><input class="ui big red button" type="button" value="Register"></a></div>
</div>