...
<button class="ui small black button"><a href="/Chef/controleur-index.php"> Home </a></button>
<button class="ui small black button"><a href="/Chef/Controleur/controleur-about.php">About me</a></button>
<button class="ui small black button"><a href="/Chef/Controleur/controleur-contact.php">Contact</a> </button>
